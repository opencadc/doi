...
public class DoiJsonReaderWriterTest
{
    ...
    public void readValidDoiMetadata()
    {
        try
        {
            ...
            FileWriter fWriter = new FileWriter("src/test/data/jsonWriterDocFromXmlReaderOut.json", false);
            fWriter.write(jsonBuilder.toString());
            fWriter.close();
            ...
            fWriter = new FileWriter("src/test/data/xmlWriterDocFromJsonWriterOut.xml", false);
            fWriter.write(xmlBuilder.toString());
            fWriter.close();
