...
public class CreateDocumentTest
{
    ...
    public void testCreateDocument() throws Throwable
    {
        ...
        String fileName = "src/test/data/datacite-example-full-no-identifier-v4.1.xml";
        ...
        Element identifierElement = rootElement.getChild("identifier", rootElement.getNamespace());
        Assert.assertTrue("Test xml document contains an identifier", identifierElement.getText().isEmpty());
        ...
        Subject.doAs(s, new PrivilegedExceptionAction<Object>()
        {
            public Object run() throws Exception
            {
                ...
                log.debug("doi identifier of created document is " + identifier.getText());
                return doc;
            }
        });
    }
