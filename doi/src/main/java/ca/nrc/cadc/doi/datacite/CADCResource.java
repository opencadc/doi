...
public class CADCResource extends Resource {
     ...
     *
     * Resource with the Publisher set to CADC.
     *
    ...
    public CADCResource(Namespace namespace, Identifier identifier, List<Creator> creators,
                        List<Title> titles, PublicationYear publicationYear, DoiResourceType resourceType) {
        super(namespace, identifier, creators, titles, new Publisher(Publisher.VALID_PUBLISHER),
