...
export interface RaftStatusChange {
  fromStatus: string
  toStatus: string
  changedBy: string
  changedAt: string
...
export interface RaftData extends TRaftSubmission {
  ...
  reviewer?: string | null
  /** ISO timestamp of first submission for review */
  submittedAt?: string
  /** Version number — increments on resubmit after revert */
  version?: number
  /** History of status transitions */
  statusHistory?: RaftStatusChange[]
}
